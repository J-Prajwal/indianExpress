  ...
  return (
   ...
   <div className='Entertainment'>
    ...
    <div className={styles.first}>
      <img src="https://images.indianexpress.com/2013/12/sushant.jpeg" alt="sushant" height={417} />
...
On Sushant Singh Rajput's second death anniversary, all the major players from Rhea Chakraborty to Siddharth Pithani and where they are now</h3>
    ...
    <div className='second'>
      <div className='subnews1'>
        <img src="https://images.indianexpress.com/2021/08/Anupam-Kher-wishes-wife-Kirron-Kher-a-happy-36th-wedding-anniversary-1200.jpg?resize=450,250" alt=""  width={250}/>
